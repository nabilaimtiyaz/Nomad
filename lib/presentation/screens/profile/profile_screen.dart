            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: Column(children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('${Formatters.commas(1000)} SILVER',
                            style: const TextStyle(fontSize: 10,
                              color: AppColors.textSecondary)),
                          Text('${Formatters.commas(nextTierPts)} GOLD',
                            style: const TextStyle(fontSize: 10,
                              color: AppColors.textSecondary)),
                        ]),
                      ]),
                  ...
                  _item(icon: Icons.person_outline_rounded,
                    label: 'Personal Information',
                    sub: '${user.name}  •  ${user.phone}',
                    onTap: () => Get.toNamed(AppRoutes.editProfile)),
                  _item(icon: Icons.receipt_long_outlined,
                    label: 'Order History', sub: 'Lihat semua pesanan',
                    onTap: () => Get.toNamed(AppRoutes.orderHistory)),
                  _item(icon: Icons.payment_rounded,
                    label: 'Payment Methods', sub: 'Kelola metode bayar',
                    onTap: () => Get.snackbar('Info', 'Segera hadir!',
                      snackPosition: SnackPosition.BOTTOM)),
                  _item(icon: Icons.discount_outlined,
                    label: 'Vouchers & Offers', badge: '2 NEW',
                    onTap: () => Get.toNamed(AppRoutes.voucher)),
                  _item(icon: Icons.notifications_outlined,
                    label: 'Notifikasi', sub: 'Promo, reminder, update pesanan',
                    onTap: () => Get.snackbar('Info', 'Segera hadir!',
                      snackPosition: SnackPosition.BOTTOM)),
                  _item(icon: Icons.help_outline_rounded,
                    label: 'Bantuan & FAQ',
                    onTap: () => Get.snackbar('Info', 'Segera hadir!',
                      snackPosition: SnackPosition.BOTTOM)),
